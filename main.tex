...
% ==== SLIDE 15 ====
\begin{frame}{Componente Bayesiano}
...
\begin{frame}{Trabajo Futuro}
    ...
    \begin{itemize}
        ...
        \item Desarrollo de algoritmos más sofisticados para el deterioro artificial.
        \item Utilizar la binarización proporcionada por el SDK de NeuroTec como el objetivo de la reconstrucción.
        \item Conformar un dataset con deterioros reales y las correspondientes huellas originales.
    \end{itemize}
